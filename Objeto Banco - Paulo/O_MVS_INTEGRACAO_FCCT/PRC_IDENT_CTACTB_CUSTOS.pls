...
IS
    ...
    <objeto>
     ...
     <alteracao>09/07/2020 16:00</alteracao>
     <descricao>
     Verificação lógica para o Rateio do Captation que agora é independente.
     Classificar a conta de coparticipação na despesa, independente da operadora. So estava permitindo em Unimeds</descricao>
