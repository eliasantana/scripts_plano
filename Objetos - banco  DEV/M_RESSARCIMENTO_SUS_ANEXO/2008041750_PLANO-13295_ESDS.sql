...
CREATE OR REPLACE PROCEDURE dbaps.prc_gera_reembolso_ressarc_sus (PCD_RESSARCIMENTO_SUS IN NUMBER, PCD_USUARIO_LOGADO IN VARCHAR2) IS
  ...
  /**************************************************************
    ...
    <alteracao>05/08/2020 18:42</alteracao>
    <descricao>Processar Ressarcimento apenas para itens selecionados</descricao>
    <versao>1.5</versao>
...
BEGIN
	...
	BEGIN
      ...
      END IF; --END IF rAtendimentos.CD_MATRICULA IS NOT NULL
      --
      --
