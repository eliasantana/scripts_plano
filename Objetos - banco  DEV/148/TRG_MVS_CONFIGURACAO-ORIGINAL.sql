...
FOR EACH ROW
  ...
  /**************************************************************
    <objeto>
     ...
     <alteracao>06/08/2020 15:07</alteracao>
     <ultimaAlteracao>
       Adicionado validac?o na chave CONTMED_MUDA_GLOSA_DUPLICIDADE. (Jarbas Junior)
       Adicionado validac?o na chace CONTMED_CALC_ACOMODACAO_CO_FI. (Maikon Oliveira)
       Adicionado validac¿o na chave REEMB_FORNC_LISTA_TODOS. (Allison Magno)
     </ultimaAlteracao>
